...
export default function Home() {
  ...
  return (
    ...
    >
      ...
      {/* Soft glow from top-right corner — matches image 2 lighting */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-20 -right-20 w-[600px] h-[600px] rounded-full bg-emerald-300/10 blur-3xl" />
